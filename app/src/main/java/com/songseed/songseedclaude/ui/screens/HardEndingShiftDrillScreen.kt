...
import com.songseed.songseedclaude.viewmodel.HardEndingShiftViewModel

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun HardEndingShiftDrillScreen(
    onBack: () -> Unit,
    onHome: () -> Unit,
    viewModel: HardEndingShiftViewModel = viewModel()
) {
        ...
        Column(
            ...
            if (!isExampleVisible) {
                OutlinedButton(
                    ...
                    Text("Show Example", fontSize = 18.sp)
                }
